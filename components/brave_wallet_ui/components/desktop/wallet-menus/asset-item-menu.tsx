...
export const AssetItemMenu = (props: Props) => {
  ...
  const canShieldFunds = React.useMemo(() => {
    return availableShieldedAccountData && !asset.isShielded
  }, [availableShieldedAccountData, asset.isShielded])

  const canUnshieldFunds = React.useMemo(() => {
    return (
